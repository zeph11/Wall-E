                  ...
                  child: Table(
                      ...
                      children: [
                        ...
                        TableRow(children: [
                          ...
                          Text('Eating out', style: TextStyle(fontSize: 16)),
                          Container(
                            padding: EdgeInsets.only(
                                left: 35, right: 10, bottom: 15),
                        ...
                        TableRow(children: [
                          ...
                          Text('Bills&Rent', style: TextStyle(fontSize: 16)),
                          Container(
                            padding: EdgeInsets.only(
                                left: 35, right: 10, bottom: 15),
                        ...
                        TableRow(children: [
                          ...
                          Text('Laundry', style: TextStyle(fontSize: 16)),
                          Container(
                            padding: EdgeInsets.only(
                                left: 35, right: 10, bottom: 15),
                        ...
                        TableRow(children: [
                          ...
                          Text('Gifts', style: TextStyle(fontSize: 16)),
                          Container(
                            padding: EdgeInsets.only(
                                left: 35, right: 10, bottom: 15),
